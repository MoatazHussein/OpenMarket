...
export class FooterComponent {
  ...
  ElementsColumn_01:any= [{name : "ما هو موقع وسيلتي؟",link:"About"},{name : "الخدمات الاعلانية",link:"not-found"},{name : "خريطة الموقع",link:"not-found"}/*,{name : "دول أخرى",link:"about"}*/];
  ElementsColumn_02:any= [{name : "مساعدة",link:"not-found"},{name : "فريق المبيعات",link:"SalesTeam"},{name : "شروط الاستخدام",link:"TermsOfUse"},{name : "سياسة الخصوصية",link:"PrivacyPolicy"},{name:"قواعد السلامة",link:"not-found"}];
