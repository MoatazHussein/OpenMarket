...
export class FooterComponent {
  ...
  ElementsColumn_01:any= [{name : "ما هو موقع وسيلتي؟",link:"About"},{name : "الخدمات الاعلانية",link:"AdvertisingServices"},{name : "خريطة الموقع",link:"SiteMap"}/*,{name : "دول أخرى",link:"about"}*/];
